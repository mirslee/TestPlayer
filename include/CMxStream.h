...
public:
    ...
    CMxStream *vlc_stream_CommonNew(vlc_object_t *, void (*)(CMxStream *));
    CMxStream *vlc_stream_MemoryNew(vlc_object_t *obj, uint8_t *base,size_t size, bool preserve);
    CMxStream * vlc_stream_NewURL(vlc_object_t *obj, const char *url);
    CMxStream *vlc_stream_fifo_New(vlc_object_t *parent);
    int vlc_stream_fifo_Queue(CMxStream *s, block_t *block);
