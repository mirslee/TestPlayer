...
//    info_category_t **pp_catevgories; /**< Pointer to the first info category */
    ...
    MxMutex lock;                 /**< Lock for the item */
...
MXCODEC_API void input_item_SetName( input_item_t *p_item, const char *psz_name );
 ...
 */
MXCODEC_API input_item_node_t * input_item_node_Create( input_item_t *p_input ) MX_USED;

/**
 * Add a new child node to this parent node that will point to this subitem.
 */
MXCODEC_API input_item_node_t * input_item_node_AppendItem( input_item_node_t *p_node, input_item_t *p_item );

/**
 * Add an already created node to children of this parent node.
 */
MXCODEC_API void input_item_node_AppendNode( input_item_node_t *p_parent, input_item_node_t *p_child );
 ...
 */
MXCODEC_API void input_item_node_Delete( input_item_node_t *p_node );
 ...
 */
MXCODEC_API int input_item_AddOption(input_item_t *, const char *, unsigned i_flags );
/**
 * This function add several options to an existing input_item_t.
 */
MXCODEC_API int input_item_AddOptions(input_item_t *, int i_options,
                                  const char *const *ppsz_options,
                                  unsigned i_flags );
MXCODEC_API int input_item_AddOpaque(input_item_t *, const char *, void *);

void input_item_ApplyOptions(CMxObject *, input_item_t *);

MXCODEC_API bool input_item_slave_GetType(const char *, enum slave_type *);

MXCODEC_API input_item_slave_t *input_item_slave_New(const char *, enum slave_type,
                                                 enum slave_priority);
 ...
 */
MXCODEC_API int input_item_AddSlave(input_item_t *, input_item_slave_t *);

/* */
MXCODEC_API bool input_item_HasErrorWhenReading( input_item_t * );
MXCODEC_API void input_item_SetMeta( input_item_t *, MxMetaType meta_type, const char *psz_val );
MXCODEC_API bool input_item_MetaMatch( input_item_t *p_i, MxMetaType meta_type, const char *psz );
MXCODEC_API char * input_item_GetMeta( input_item_t *p_i, MxMetaType meta_type ) MX_USED;
MXCODEC_API char * input_item_GetName( input_item_t * p_i ) MX_USED;
MXCODEC_API char * input_item_GetTitleFbName( input_item_t * p_i ) MX_USED;
MXCODEC_API char * input_item_GetURI( input_item_t * p_i ) MX_USED;
MXCODEC_API char * input_item_GetNowPlayingFb( input_item_t *p_item ) MX_USED;
MXCODEC_API void input_item_SetURI( input_item_t * p_i, const char *psz_uri );
MXCODEC_API mtime_t input_item_GetDuration( input_item_t * p_i );
MXCODEC_API void input_item_SetDuration( input_item_t * p_i, mtime_t i_duration );
MXCODEC_API bool input_item_IsPreparsed( input_item_t *p_i );
MXCODEC_API bool input_item_IsArtFetched( input_item_t *p_i );

#define INPUT_META( name ) \
static inline \
void input_item_Set ## name (input_item_t *p_input, const char *val) \
{ \
input_item_SetMeta (p_input, MxMetaType_ ## name, val); \
} \
static inline \
char *input_item_Get ## name (input_item_t *p_input) \
{ \
return input_item_GetMeta (p_input, MxMetaType_ ## name); \
}
...
MXCODEC_API char * input_item_GetInfo( input_item_t *p_i, const char *psz_cat,const char *psz_name ) MX_USED;
MXCODEC_API int input_item_AddInfo( input_item_t *p_i, const char *psz_cat, const char *psz_name, const char *psz_format, ... ) MX_FORMAT( 4, 5 );
MXCODEC_API int input_item_DelInfo( input_item_t *p_i, const char *psz_cat, const char *psz_name );
MXCODEC_API void input_item_ReplaceInfos( input_item_t *, info_category_t * );
MXCODEC_API void input_item_MergeInfos( input_item_t *, info_category_t * );
 ...
 */
MXCODEC_API input_item_t * input_item_NewExt( const char *psz_uri,
                                         const char *psz_name,
                                         mtime_t i_duration, int i_type,
                                         enum input_item_net_type i_net ) MX_USED;
 ...
 */
MXCODEC_API input_item_t * input_item_Copy(input_item_t * ) MX_USED;

/** Holds an input item, i.e. creates a new reference. */
MXCODEC_API input_item_t *input_item_Hold(input_item_t *);

/** Releases an input item, i.e. decrements its reference counter. */
MXCODEC_API void input_item_Release(input_item_t *);
...
MXCODEC_API int libvlc_MetadataRequest( libvlc_int_t *, input_item_t *,
                                   input_item_meta_request_option_t,
                                   int, void * );
MXCODEC_API int libvlc_ArtRequest(libvlc_int_t *, input_item_t *,
                              input_item_meta_request_option_t );
MXCODEC_API void libvlc_MetadataCancel( libvlc_int_t *, void * );
 ...
 */
MXCODEC_API void vlc_readdir_helper_init(struct vlc_readdir_helper *p_rdh,
 ...
 */
MXCODEC_API void vlc_readdir_helper_finish(struct vlc_readdir_helper *p_rdh, bool b_success);
 ...
 */
MXCODEC_API int vlc_readdir_helper_additem(struct vlc_readdir_helper *p_rdh,
