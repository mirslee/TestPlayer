 ...
 * iconv wrapper
 *****************************************************************************/
MxIconv mxIconvOpen( const char *tocode, const char *fromcode )
{
#ifndef __linux__
...
size_t mxIconv( MxIconv cd, const char **inbuf, size_t *inbytesleft,
                  char **outbuf, size_t *outbytesleft )
{
    size_t ret;

#ifndef __linux__
    if ( cd == (MxIconv)(-2) || cd == (MxIconv)(-3) )
    {
        unsigned char *out = NULL;
        if (outbuf != NULL)
            out = (unsigned char *)*outbuf;

        const uint16_t *ucs4_table = ( cd == (MxIconv)(-2) ? ISO6937toUCS4 : ISO6937_2toUCS4 );
