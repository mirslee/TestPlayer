...
struct fourcc_mapping {
    union { unsigned char alias_str[4]; MxFourcc alias; };
    union { unsigned char fourcc_str[4]; MxFourcc fourcc; };
};
struct fourcc_desc {
    union { unsigned char alias_str[4]; MxFourcc alias; };
    const char desc[52];
...
static const struct fourcc_mapping mapping_video[] = {
    ...
    { { { 0x42, 0x50, 0x47, 0x20 } }, { { 0x42, 0x50, 0x47, static_cast<unsigned char>(0xfffb) } } },
...
static const struct fourcc_desc desc_video[] = {
    ...
    { { { 0x42, 0x50, 0x47, static_cast<unsigned char>(0xfffb) } }, "BPG Image" },
